...
object Page {
    ...
    const val CHECKOUT_PROCESSING = "page.checkout.processing"
    ...
    const val ORDER_START_DELIVERY = "page.order.start-delivery"
    const val ORDERS = "page.orders"
    const val PRODUCT = "page.product"
    const val MY_ORDER = "page.my-order"
    const val MY_ORDERS = "page.my-orders"
    ...
    const val SETTINGS_STORE_PRODUCT_SECTION = "page.settings.store.product.section"
    ...
    const val SETTINGS_STORE_SECTION_LIST = "page.settings.section.list"
    const val SETTINGS_STORE_SECTION_ADD = "page.settings.store.section.add"
    const val SETTINGS_STORE_SECTION_EDIT = "page.settings.store.section.edit"
